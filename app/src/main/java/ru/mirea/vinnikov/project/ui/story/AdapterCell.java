...
public class AdapterCell extends RecyclerView.Adapter<AdapterCell.StoryHolder>{
    List<ru.mirea.vinnikov.project.ui.story.Cell> story;

    public AdapterCell(List<ru.mirea.vinnikov.project.ui.story.Cell> story){
        this.story = story;
    }
    ...
    class StoryHolder extends RecyclerView.ViewHolder{
        ...
        void bind(int listIndex){
            ru.mirea.vinnikov.project.ui.story.Cell cell = story.get(listIndex);
